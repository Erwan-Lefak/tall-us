...
ZAI_API_KEY="a410fa72ccab499f9faf81215923cd22.6OzefCxi72S3jJ5T"
...
log_info() {
    echo "🔹 $*"    {
      "env": {
        "ANTHROPIC_AUTH_TOKEN": "a410fa72ccab499f9faf81215923cd22.6OzefCxi72S3jJ5T",
...
configure_claude() {
    ...
    local api_key="${ZAI_API_KEY:-${ANTHROPIC_AUTH_TOKEN:-}}"
    if [ -n "$api_key" ]; then
