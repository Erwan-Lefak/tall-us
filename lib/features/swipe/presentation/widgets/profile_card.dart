                      ...
                      ClipRRect(
                        ...
                        child: widget.profile.photoUrls.isNotEmpty
                            ? CachedNetworkImageWidget(
                                imageUrl: widget.profile.photoUrls.first,
                                fit: BoxFit.cover,
                ...
                if (widget.profile.prompts.isNotEmpty)
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...List.generate(widget.profile.prompts.length,
                            (index) {
                          final prompt = widget.profile.prompts[index];
                          return Padding(
